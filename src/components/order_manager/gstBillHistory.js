              ...
              <Card className="p-0">
                <Card.Header>
                  ...
                  <p className="text-center">
                    ...
                    <hr />
                    email ID: d.b.foodsandbeverages8999@gmail.com
                  </p>
                  <hr />
                  ...
                  >
                    ...
                    <p>
                      Date <b>{moment(this.state.date).format("D/M/YYYY")}</b>
                    </p>
                  </span>
                  <Card.Title className="text-center pb-0 mb-0">
                    <h5>
                ...
                <Card.Body className="pb-3 mb-0">
                  ...
                  <Row>
                    <Col md={6}>
                      ...
                      >
                        Aadhar Card No.: <b>{this.state.aadharCard}</b>
                      </h6>
                    </Col>
                    <Col md={6}>
                      <h6
                      ...
                      >
                        Date:{" "}
                        <b>{moment(this.state.date).format("DD/MM/YYYY")}</b>
                      </h6>
                    </Col>
                  </Row>
                  <Row>
                    ...
                    {this.state.itemsList.length > 0 ? (
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td colSpan="2">{this.state.gst / 2}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td colSpan="2">{this.state.adjustment}</td>
                        </tr>
                        <tr>
                ...
                <Card.Footer className="pb-3 mb-0">
                  <Row>
                    ...
                    <Col md={4}>
                      <img src={qrCodeImg} height="100%" width="100%" />
                    </Col>
                    <Col md={4}>
                      <h6
                        style={{
